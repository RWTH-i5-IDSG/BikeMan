...
public class ViewStationSlotDTO {
    ...
    public ViewStationSlotDTO(Long stationSlotId, String manufacturerId, Integer slotPosition, OperationState state, Boolean isOccupied, Long pedelecId, String pedelecManufacturerId) {
    ...
    class StationSlotPedelecDTO {
        ...
        StationSlotPedelecDTO(Long pedelecId, String manufacturerId) {
