...
import de.rwth.idsg.bikeman.app.service.SupportService;
...
public class SupportResource {
    ...
    public void sendFeedback (HttpServletResponse response, @Valid @RequestBody CreateFeedbackDTO data) {
        ...
        supportService.sendFeedbackMail(customerService.getCurrentCustomer(), data.getSubject(), data.getContent());
    }
    ...
    public void sendStationSupport (HttpServletResponse response, @Valid @RequestBody CreateStationSupportDTO data) {
        // TODO: Create a ticket in support system
        supportService.sendStationSupportMail(customerService.getCurrentCustomer(), data.getStationId(), data.getError(), Optional.ofNullable(data.getContent()));
    }
    ...
    public void sendPedelecSupport (HttpServletResponse response, @Valid @RequestBody CreatePedelecSupportDTO data) {
        // TODO: Create a ticket in support system
        supportService.sendPedelecSupportMail(customerService.getCurrentCustomer(), data.getPedelecId(), data.getError(), Optional.ofNullable(data.getContent()));
    }
