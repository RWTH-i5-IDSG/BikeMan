...
public class PedelecResourceTest {
    ...
    public void setup() {
        ...
        this.restPedelecMockMvc = MockMvcBuilders.standaloneSetup(pedelecResource).build();

        pedelec = new Pedelec();
//        pedelec.setId(DEFAULT_ID);
//    	pedelec.setSampleDateAttribute(DEFAULT_SAMPLE_DATE_ATTR);
//    	pedelec.setSampleTextAttribute(DEFAULT_SAMPLE_TEXT_ATTR);
    }
